                    ...
                    <div className="space-y-2 s,:space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-1 gap-4 sm:space-x-0 min-w-0">
                                {task.assignee && (
                                    <div className="flex items-center space-x-1 text-xs text-gray-900 gap-1">
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="container mx-auto px-2 sm:px-4 py-4 sm:py-6">
                ...
                lg:[&::-webkit-scrollbar-thumb]:bg-gray-300 :rounded-full space-y-4 lg:space-y-0
                ">
...
// function useSortable(arg0: { id: string; }): { attributes: any; listeners: any; } {
