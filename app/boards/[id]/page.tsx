            ...
            <Card className="cursor-pointer hover:shadow-md transition-shadow">
                <CardContent className="p-3 sm:p-4">
                    <div className="space-y-2 sm:space-y-3">
                        ...
                        {/* Task Meta */}
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-1 gap-4 sm:space-x-0 min-w-0">
                                {task.assignee && (
                                    <div className="flex items-center space-x-1 text-xs text-gray-500 gap-1">
...
function TaskOverlay({ task }: { task: Task }) {
    ...
    return (
        <Card className="cursor-pointer hover:shadow-md transition-shadow">
            <CardContent className="p-3 sm:p-4">
                <div className="space-y-2 s,:space-y-3">
                    {/* Task Header */}
                    <div className="flex items-center justify-between">
                        <h4 className="font-medium text-gray-900 text-sm leading-tight flex-1 min-w-0 pr-2">
                            {task.title}
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className={`w-2 h-2 rounded-full flex-shrink-0 ${getPriorityColor(
                            task.priority
                        )}`}
                        />
                    </div>
...
export default function BoardPage() {
    ...
    async function handleDragEnd(event: DragEndEvent) {
        ...
        if (targetColumn) {
            ...
            // Check to see if were dropping on another
            const sourceColumn = columns.find((col) =>
                col.tasks.some((task) => task.id === taskId)
            );
                ...
                <main className="container mx-auto px-2 sm:px-4 py-4 sm:py-6">
                    ...
                    >
                        <div
                         ...
                         lg:[&::-webkit-scrollbar-thumb]:bg-gray-100
            ...
            <Dialog open={isCreatingColumn} onOpenChange={setIsCreatingColumn}>
                <DialogContent className="w-[95vw] max-w-[425px] mx-auto">
                    <DialogHeader>
                        ...
                        <p className="text-sm text-gray-600">
                            Add new column to organize you tasks
                        </p>
                    </DialogHeader>
